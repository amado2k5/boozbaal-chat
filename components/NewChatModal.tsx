    ...
    <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50 transition-opacity" onClick={handleClose}>
        <div className="bg-gray-800 rounded-lg shadow-2xl p-8 w-full max-w-lg relative border border-gray-700" onClick={e => e.stopPropagation()}>
            ...
            <div className="text-center">
                ...
                {!generatedLink && <p className="text-gray-400 mt-2">Enter your friend's details to generate a unique chat link.</p>}
            </div>
            ...
            <div className="mt-6">
                {!generatedLink ? (
                    ...
                    <div className="text-center space-y-4">
                        <h3 className="text-lg font-semibold text-green-400">Invitation Link Generated!</h3>
                        <p className="text-gray-300">
                           No email has been sent. Please copy the link below and share it with <span className="font-semibold text-white">{name}</span> manually.
                        </p>
